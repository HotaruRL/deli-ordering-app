...
public class Order {
    ...
    // getters
    public double getSALE_TAXES() {
        return SALE_TAXES;
    }

    public double getSALE_TAXESToDisplay() {
        return SALE_TAXES * 100;
    }
    ...
    public String getIsCustomizing() {
        return isCustomizing;
    }

    // setters
    public void setIsCustomizing(String isCustomizing) {
